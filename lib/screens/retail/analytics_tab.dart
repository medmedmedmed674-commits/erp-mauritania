...
///
/// ## Layout
/// A compact date selector button at the top shows the selected date
/// (e.g. "19/8/2026"). Tapping it opens Flutter's standard popup
/// [showDatePicker] modal — no full-page calendar grid is rendered.
///
/// Selecting a date instantly recomputes:
///   - Total Sales for that day
///   - Net Profit for that day
///   - Number of invoices issued that day
///   - Average invoice value
///   - A scrollable itemized list of every invoice issued on that
///     date — each row tappable to re-open the printable
///     [InvoiceDialog] (PDF / PNG / Print).
...
/// Compact date selector button. Shows the selected date with a
/// calendar icon; tapping it launches the standard popup DatePicker.
